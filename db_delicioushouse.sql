DROP DATABASE IF EXISTS `db_delicioushouse`;

CREATE DATABASE IF NOT EXISTS `db_delicioushouse` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
use `db_delicioushouse`;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='地址管理';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='菜品及套餐分类';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='菜品管理';
